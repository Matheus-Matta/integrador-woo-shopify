...
export default function CustomerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data, isLoading } = useEntityDetail('customer', decodedId, { eventsPage, errorsPage, limitEvents: 20, limitErrors: 20 });
  ...
  return (
    <div className="flex flex-col gap-6 p-4 lg:p-6 animate-slide-up w-full">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">E-mail: {data.entityId}</span>
          </div>
        </div>
      </div>
        ...
        <TabsContent value="events">
          <Card>
            <CardHeader className="pb-3 border-b border-border/50">
              ...
              <CardDescription>
                Todos os eventos processados para este cliente.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="errors">
          <Card className="border-destructive/20">
            <CardHeader className="pb-3 border-b border-destructive/20 bg-destructive/5">
              ...
              <CardDescription>
                Erros críticos ou de infraestrutura que afetaram a sincronização deste cliente.
              </CardDescription>
            </CardHeader>
            <CardContent className="p-0">
              <Table>
      ...
      {selectedRow && (
        <LogDetailModal row={selectedRow} type="customer" onClose={() => setSelectedRow(null)} />
      )}
    </div>
  );
}
